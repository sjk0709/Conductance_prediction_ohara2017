...
class TransformerION(torch.nn.Module):
    def __init__(self,
        ...
        self.conv2 = torch.nn.Conv1d(in_channels=n_parameters, out_channels=256, kernel_size=5, 
                  	stride=3, padding=0, dilation=2, 
                  	groups=1, bias=True, padding_mode='zeros')        
        self.conv2_bn = torch.nn.BatchNorm1d(256)
        self.relu2 = torch.nn.ReLU(inplace=False)
        
        self.conv4 = torch.nn.Conv1d(in_channels=256, out_channels=d_model, kernel_size=5, 
                  	stride=2, padding=0, dilation=2, 
                  	groups=1, bias=True, padding_mode='zeros')
        self.conv4_bn = torch.nn.BatchNorm1d(512)
        ...
        self.conv5 = torch.nn.Conv1d(in_channels=d_model, out_channels=256, kernel_size=5, 
                  	stride=2, padding=0, dilation=2, 
                  	groups=1, bias=True, padding_mode='zeros')
        self.relu5 = torch.nn.ReLU(inplace=False)        
        self.conv6 = torch.nn.Conv1d(in_channels=256, out_channels=128, kernel_size=5, 
                  	stride=2, padding=0, dilation=2, 
                  	groups=1, bias=True, padding_mode='zeros')
        self.conv6_bn = torch.nn.BatchNorm1d(128)
